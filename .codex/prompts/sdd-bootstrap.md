<!-- GENERATED FROM .sdd/ (commande /sdd-bootstrap) — DO NOT EDIT -->
...
2. `.sdd/templates/stack.md.template` existe
...
- `.sdd/templates/stack.md.template` — template source
- `.claude/CLAUDE.md §9` — démarrage rapide (mentionne Step 0)
- `.sdd/docs/quickstart.md` — walkthrough complet
