<!-- GENERATED FROM .sdd/ (commande /sdd-discover-stack) — DO NOT EDIT -->
...
Invoquer :
```bash
python .sdd/python/sdd_scripts/scan_repo.py \
  --scope {scope} \
...
Invoquer :
```bash
python .sdd/python/sdd_scripts/match_stack_catalog.py \
...
## Active Tech Specs
 - .sdd/stacks/backend/{backend-stack-id}.md      # score {score}, {confidence}
 - .sdd/stacks/frontend/{frontend-stack-id}.md    # score {score}, {confidence}

## Active UI Specs
 - .sdd/stacks/ui/{ui-stack-id}.md                # score {score}, {confidence}

## Active QA Specs
 - .sdd/stacks/qa/{matched-qa-stack}.md           # TODO confirmer
 - .sdd/stacks/qa/code-quality.md

## Active Auth Specs
 - .sdd/stacks/auth/{auth}.md
