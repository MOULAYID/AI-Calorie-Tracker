<!-- GENERATED FROM .sdd/ (commande /sdd-reverse-init) — DO NOT EDIT -->
<!-- Bootstrap workspace/old/{LegacyProject}/.sys/ pour le workflow reverse engineering. Crée le squelette de dossiers + un README minimal. Ne touche pas au framework. Read-only sur le legacy. -->
...
2. Créer `workspace/old/{LegacyProject}/.sys/README.md` minimal :
   ...
   Voir .claude/docs/reverse-engineering-workflow.md
   ```
...
Voir `.claude/docs/reverse-engineering-workflow.md` §1 + §2 pour le contexte pipeline.
