...
- **Pricing renseigné** : non ([TELEMETRY_UNAVAILABLE])
...
- ⚠ Lazy-load @file : absent
- ⚠ Slash-commands : émulé (wrapper)
- ⚠ Provider openai : fidélité sorties structurées « unknown » — conformance run (§10) requis avant tout SLA
- ⚠ Provider openai : pricing absent — tout run cost-cappé émettra [TELEMETRY_UNAVAILABLE] (fail-open loggué)
