...
8. **Pré-`/sdd-full`** : `python .claude/python/sdd_reverse_scripts/check_reverse_feat_for_full.py --feat-path workspace/feats/{n}-*.md`
...
- Règle anti-derive REVERSE : `.claude/rules/reverse-engineering.md`
- Loader autonome : `.claude/loader.reverse.yml`
- Module Python isolé : `.claude/python/sdd_reverse/`
- 3 CLI scripts : `.claude/python/sdd_reverse_scripts/`
- Fixture exemple : `.claude/python/tests/fixtures/legacy-webforms-minimal/`
