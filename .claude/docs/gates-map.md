...
- Two-stage auditors : `@.claude/rules/auditor-orchestration.md`
- Ownership des findings : `@.claude/rules/auditor-coordination.md`
- API Gate : `@.claude/rules/build-and-loop.md` Partie A
- Acceptance Gate : `@.claude/rules/quality.md §C`
- Classes d'erreur des gates : `@.claude/rules/error-classification.md §1.2, §1.7`
