...
## v6.8.0 → v6.9.0 (2 nouvelles rules)
...
> Note v7.0.0-alpha (2026-06-04) : le serveur MCP additif livré en v6.9
> (`.claude/python/sdd_mcp/`, manifest `.claude/mcp.json`, doc
> `MCP-SERVER.md`) a été **retiré** lors du sweep dead-code C1 — aucun
> consommateur effectif. Migration : aucune action requise pour
> utilisateurs Claude Code (la surface MCP n'impactait pas le pipeline).
