...
relates_to:
  - .claude/docs/reverse-engineering-workflow.md   # design doc maître reverse (source-files)
  - .claude/rules/reverse-engineering.md            # anti-derive + taxonomie [REVERSE_*]
  - .claude/docs/arch/phase-b-db-scaffolding.md     # précédent introspection DB live READ-ONLY
  - .claude/rules/library-and-stack.md §C           # règle DB READ-ONLY + [DB_STRUCTURE_CHANGE_FORBIDDEN]
---
...
| `.claude/python/sdd_reverse/proc.reverse.template.md` | template analyse proc (isolé, ADV-9) |
