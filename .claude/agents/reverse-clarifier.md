...
- Lire le template `.claude/python/sdd_reverse/questions.reverse.template.md`.
...
Voir `.claude/rules/reverse-engineering.md §6` (classes `[REVERSE_QUESTIONS_PENDING]`, `[REVERSE_ANSWER_INGEST_FAILED]`) + §10 (pont /sdd-full).
