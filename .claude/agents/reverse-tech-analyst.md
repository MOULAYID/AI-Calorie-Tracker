...
4. Lire `.claude/python/sdd_reverse/analysis.reverse.template.md` — si absent → STOP + ERROR `[REVERSE_TEMPLATE_MISSING]` (ADV-9, pas de fallback inline).
...
5. `.claude/python/sdd_reverse/language_signatures.yml` (pour `confidence_cap`)
6. `.claude/python/sdd_reverse/analysis.reverse.template.md`
