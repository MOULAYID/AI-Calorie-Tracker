...
> Source de verite : `.claude/stacks/mobiles/maui.libs.json`. Ne pas editer cette section manuellement -- utiliser `python .claude/python/sdd_admin/sync_stack_md.py --stack-id maui`.

#### 2.4.a Librairies CORE (installees par arch en §2.2.1, toujours)

| Lib | Version | Role |
|-----|---------|------|
| Microsoft.Maui.Controls | 9.0.x (transitif template) | Framework MAUI (built-in via workload) |
| Microsoft.Maui.Essentials | 9.0.x (transitif) | APIs natives (SecureStorage, Preferences, Connectivity, FileSystem) |
| Microsoft.Maui.Controls.Compatibility | 9.0.x (transitif) | Compat XF (transition) |
| CommunityToolkit.Mvvm | 8.4.0 | Source-gen MVVM (ObservableProperty, RelayCommand) — top-1 MVVM 2024-2025 |
| CommunityToolkit.Maui | 11.0.0 | Behaviors, Converters, Popup, Snackbar, MediaElement — top-1 toolkit MAUI |
| CommunityToolkit.Maui.Markup | 5.1.0 | Fluent C# markup (alternative XAML) |
| sqlite-net-pcl | 1.9.172 | SQLite ORM local — standard de facto MAUI |
...
| Microsoft.Extensions.Http.Resilience | 9.0.0 | Retry / circuit breaker (succede a Polly direct) |
| Refit | 8.0.0 | REST client typed (top-1 wrapper HttpClient) |
| Refit.HttpClientFactory | 8.0.0 | Integration Refit + DI |
| FluentValidation | 11.10.0 | Validation forms / models |
| Serilog.Extensions.Logging | 9.0.0 | Logger structure (peer Microsoft.Extensions.Logging) |
| Serilog.Sinks.Debug | 3.0.0 | Sink Debug (console IDE) |

#### 2.4.b Librairies ON-DEMAND (installees si l'US declenche)

| Capability | Lib | Version | Triggers |
|---|---|---|---|
| ef-sqlite | Microsoft.EntityFrameworkCore.Sqlite | 9.0.0 | ef-core, entity.*framework, ef-sqlite |
...
| charts | Microcharts.Maui | 1.0.0 | microcharts, chart.*simple |
...
| connectivity | Microsoft.Maui.Essentials | (built-in) | connectivity, network.*status |
| maps | Microsoft.Maui.Controls.Maps | 9.0.0 | maps, carte, marker (built-in MAUI 9, requires capability) |
...
| markup | CommunityToolkit.Maui.Markup | 5.1.0 | fluent.*markup, c#.*markup |
| popup | CommunityToolkit.Maui (Popup module) | 11.0.0 | popup, dialog, modal |
| desktop-targets | Microsoft.Maui.Controls (windows + maccatalyst targets) | 9.0.0 | desktop, windows.*target, macos.*target |
