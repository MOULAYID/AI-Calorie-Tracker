...
> Source de verite (future) : `.claude/stacks/fullstack/next.libs.json` — a generer.
...
| react-dom | 19.0.0 | DOM renderer (server + client) |
| typescript | 5.7.0 | TS strict |
| @types/react | 19.0.0 | Types React 19 |
| @types/node | 22.10.0 | Types Node |
| tailwindcss | 4.0.0 | CSS framework |
| @tailwindcss/postcss | 4.0.0 | PostCSS plugin |
| postcss | 8.5.0 | PostCSS |
| zod | 3.24.0 | Validation schemas (server + client) |
| react-hook-form | 7.54.2 | Forms client + Server Actions |
| @hookform/resolvers | 3.10.0 | Adapter Zod ↔ RHF |
| next-auth | 5.0.0-beta.25 | Auth (NextAuth v5 / Auth.js) |
| next-intl | 3.26.0 | i18n |
| pino | 9.5.0 | Logger structure |
| pino-pretty | 13.0.0 | Formatter logs dev |
| eslint | 9.17.0 | Linting |
| eslint-config-next | 15.1.0 | Regles Next-specific |

> **shadcn/ui** : composants generes a la demande via `npx shadcn@latest add <component>`. Catalogue dans `.claude/stacks/ui/shadcn.md §2.4`.

#### 2.4.b Librairies ON-DEMAND (installees si l'US declenche)

| Capability | Lib | Version | Triggers |
|---|---|---|---|
| prisma | prisma | 6.1.0 | DatabaseType.*\\b(SqlServer\|PostgreSql\|MySql\|Sqlite)\\b, orm, db-first |
| prisma | @prisma/client | 6.1.0 | (idem) |
| auth-azure-ad | @azure/msal-node | 3.1.0 | auth-azure-ad, msal |
| jwt | jose | 5.9.6 | \\bjwt\\b, auth-local, auth-azure-ad |
| http-client | undici | 7.2.0 | appel.*api.*externe, http-client |
| excel | exceljs | 4.4.0 | \\bexcel\\b, \\.xlsx\\b, export.*excel |
| pdf | @react-pdf/renderer | 4.1.5 | \\bpdf\\b, export.*pdf, generer.*pdf |
