...
#
# REGLE DE VERSIONING (conforme a .claude/rules/stack-completeness.md §0) :
...
Appliquer `.claude/rules/stack-completeness.md` (derniere version stable LTS, .NET 10 LTS).
