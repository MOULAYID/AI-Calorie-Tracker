...
> Source de verite (future) : `.claude/stacks/fullstack/nuxt.libs.json` — a generer.
...
| vee-validate | 4.14.7 | Forms validation |
| @vee-validate/zod | 4.14.7 | Adapter Zod ↔ VeeValidate |
| pinia | 2.3.0 | State store client |
| @pinia/nuxt | 0.9.0 | Integration Nuxt + Pinia |
| @sidebase/nuxt-auth | 0.10.0 | Auth (NextAuth-like pour Nuxt) |
| @nuxtjs/i18n | 9.1.0 | i18n |
| @nuxt/eslint | 0.7.4 | Linting |
| pino | 9.5.0 | Logger serveur |
| pino-pretty | 13.0.0 | Formatter logs dev |
| h3 | (transitif Nuxt) | Engine HTTP Nitro |
...
| nuxt-ui | @nuxt/ui | 3.0.0-alpha.10 | nuxt-ui, ui-kit-nuxt |
| auth-azure-ad | @azure/msal-node | 3.1.0 | auth-azure-ad, msal |
| http-client | ofetch | 1.4.1 | appel.*api.*externe (built-in $fetch utilise ofetch) |
| excel | exceljs | 4.4.0 | \\bexcel\\b, \\.xlsx\\b, export.*excel |
| pdf | pdfkit | 0.15.2 | \\bpdf\\b, export.*pdf |
