...
> Source de verite (future) : `.claude/stacks/fullstack/kotlin-mustache.libs.json` — a generer.

#### 2.4.a Librairies CORE (installees par arch en §2.2.1, toujours)

| Lib | Version | Role |
|-----|---------|------|
| Spring Boot | 3.4.1 | Framework (BOM) |
| Kotlin | 2.1.0 | Langage |
| kotlinx-coroutines-core | 1.10.1 | Coroutines |
...
| jackson-module-kotlin | 2.18.2 | JSON serialization Kotlin-aware |
| HikariCP | (transitif starter-jpa) | DataSource pool |
| logback-classic | (transitif Boot) | Logging |
| (driver DB selectionne par arch) | — | Selon `DatabaseType` |

#### 2.4.b Librairies ON-DEMAND (installees si l'US declenche)

| Capability | Lib | Version | Triggers |
|---|---|---|---|
| db-postgres | org.postgresql:postgresql | 42.7.4 | DatabaseType.*PostgreSql, postgres |
| db-mysql | com.mysql:mysql-connector-j | 9.1.0 | DatabaseType.*MySql, mysql, mariadb |
| db-sqlserver | com.microsoft.sqlserver:mssql-jdbc | 12.8.1.jre11 | DatabaseType.*SqlServer |
| db-sqlite | org.xerial:sqlite-jdbc | 3.47.1.0 | DatabaseType.*Sqlite |
| htmx | webjars:htmx.org | 2.0.4 | htmx, partial.*reload, server.*fragment |
| alpine | webjars:alpinejs | 3.14.8 | alpine, alpine\\.js, mini.*reactive |
| flyway | org.flywaydb:flyway-core | 11.1.0 | flyway, migrations, db.*versionning |
| openapi | org.springdoc:springdoc-openapi-starter-webmvc-ui | 2.7.0 | swagger, openapi, /api-docs |
| jwt | io.jsonwebtoken:jjwt-api | 0.12.6 | \\bjwt\\b, auth-local |
| azure-ad | com.azure.spring:spring-cloud-azure-starter-active-directory | 5.18.0 | auth-azure-ad, msal, azure-ad |
| excel | org.apache.poi:poi-ooxml | 5.4.0 | \\bexcel\\b, \\.xlsx\\b, export.*excel |
| pdf | com.lowagie:itext | 4.0.5 | \\bpdf\\b, export.*pdf, generer.*pdf |
| smtp | spring-boot-starter-mail | 3.4.1 | email, smtp, envoi.*mail |
| http-client | org.springframework:spring-webflux | (transitif Boot) | webclient, http-client (WebClient) |
| caffeine-cache | com.github.ben-manes.caffeine:caffeine | 3.2.0 | cache, performance, memoization |
| code-quality | jlleitschuh.gradle.ktlint (plugin) | 12.1.2 | ktlint, code-quality (active dans build.gradle.kts) |
<!-- LIBS_CATALOG_END -->
