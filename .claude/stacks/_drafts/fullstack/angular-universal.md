...
> Source de verite (future) : `.claude/stacks/fullstack/angular-universal.libs.json` — a generer.
...
| zone.js | 0.15.0 | Zone-based change detection (deprecated en faveur de signals — restent CORE en v19) |
| @ngx-translate/core | 16.0.4 | i18n runtime |
| @ngx-translate/http-loader | 16.1.1 | HTTP loader pour json i18n |
| @azure/msal-angular | 4.0.3 | Auth Azure AD (selon `## Active Auth Specs`) |
| @azure/msal-browser | 4.0.0 | (idem) |
| eslint | 9.17.0 | Linting |
| @angular-eslint/builder | 19.0.0 | ng lint integration |
...
| http-client (server) | undici | 7.2.0 | appel.*api.*externe (server-side) |
