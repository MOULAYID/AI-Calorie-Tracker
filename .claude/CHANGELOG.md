...
>
> Politique complète : `@.claude/VERSIONING.md`.
...
- **`.claude/VERSIONING.md` créé** — politique SemVer stricte + RFC ADR
...
### Backlog v6.9 — livré (cf. entrée v6.9.0 ci-dessus)

- ✅ **MCP server** : livré 100 % en v6.9.0 (14 tools, stdio + HTTP + MCPB,
  98 tests). Détail : `@.claude/docs/MCP-SERVER.md`.
