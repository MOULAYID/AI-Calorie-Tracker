...
YAML_PATH = _PY / "code_review_patterns.yaml"
# Bi-racine 2026-07-25 : rules migrées vers .sdd/rules/ ; rules_dir()
# retourne .sdd/rules/ si présent, sinon .claude/rules/ (fallback legacy).
ERROR_CLASS_PATH = rules_dir() / "error-classification.md"
