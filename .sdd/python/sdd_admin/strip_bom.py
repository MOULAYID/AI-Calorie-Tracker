...
Usage:
    python .sdd/python/sdd_admin/strip_bom.py
    python .sdd/python/sdd_admin/strip_bom.py --check   # report only, no write
"""
...
# Bi-racine 2026-07-25 (MIGRATION-PLAN Phase 1) : rules/stacks/templates
# migrées vers `.sdd/` (foyer neutre). Agents/commands/docs restent dans
# `.claude/` (générés post-Phase 2). `.sdd/` scanné intégralement.
SEARCH_ROOTS = [
    Path(".sdd/agents"),
    Path(".sdd/commands"),
    Path(".sdd/rules"),
