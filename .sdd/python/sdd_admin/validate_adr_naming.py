...
nommage des ADRs. Émet une erreur si un fichier `.sdd/docs/adrs/ADR-*.md`
...
from sdd_lib.paths import workspace_root, docs_dir  # noqa: E402

# Bi-racine 2026-07-25 : docs migré vers .sdd/docs/.
DEFAULT_ADRS_DIR = docs_dir(ROOT) / "adrs"
