...
Detects drift between `.sdd/templates/*.md` and their expected
...
CI wiring : `.github/workflows/sdd-ci.yml` calls
  `python .sdd/python/sdd_admin/validate_templates.py --strict`
"""
...
from sdd_lib.paths import templates_dir, repo_root  # noqa: E402
