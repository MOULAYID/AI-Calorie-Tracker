...
`python .sdd/python/sdd_scripts/quality_scan.py` sur le code de
...
- .sdd/stacks/qa/code-quality.md      # active le scan sonar-like
```
...
- **Workaround actuel** : retirer la ligne
  `- .sdd/stacks/qa/code-quality.md` de `## Active QA Specs`
