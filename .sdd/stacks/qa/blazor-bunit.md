...
> §2.4 (Librairies) régénérée depuis `blazor-bunit.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id blazor-bunit`).
...
> Source de verite : `.sdd/stacks/qa/blazor-bunit.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id blazor-bunit`.
