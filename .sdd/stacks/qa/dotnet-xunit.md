...
> §2.4 (Librairies) régénérée depuis `dotnet-xunit.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id dotnet-xunit`).
...
> Source de verite : `.sdd/stacks/qa/dotnet-xunit.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id dotnet-xunit`.
