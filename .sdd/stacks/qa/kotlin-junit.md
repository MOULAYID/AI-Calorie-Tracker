...
> §2.4 (Librairies) régénérée depuis `kotlin-junit.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id kotlin-junit`).
...
> Source de verite : `.sdd/stacks/qa/kotlin-junit.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id kotlin-junit`.
