...
> §2.4 (Librairies) régénérée depuis `angular-jasmine.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id angular-jasmine`).
...
> Source de verite : `.sdd/stacks/qa/angular-jasmine.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id angular-jasmine`.
