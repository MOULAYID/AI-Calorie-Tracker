...
> Source de verite : `.sdd/stacks/qa/mutation-testing.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id mutation-testing`.
