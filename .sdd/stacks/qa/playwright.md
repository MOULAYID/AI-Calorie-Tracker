...
> Source de verite : `.sdd/stacks/qa/playwright.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id playwright`.
