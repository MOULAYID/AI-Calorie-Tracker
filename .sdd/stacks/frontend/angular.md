...
> §2.4 (Librairies) régénérée depuis `angular.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id angular`).
...
> Source de verite : `.sdd/stacks/frontend/angular.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id angular`.
