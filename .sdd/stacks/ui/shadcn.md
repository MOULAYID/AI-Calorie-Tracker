...
> §2.4 (Librairies) régénérée depuis `shadcn.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id shadcn`).
...
> Source de verite : `.sdd/stacks/ui/shadcn.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id shadcn`.
