...
> §2.4 (Librairies) régénérée depuis `vuetify.libs.json` — ne pas éditer manuellement (`python .sdd/python/sdd_admin/sync_stack_md.py --stack-id vuetify`).
...
> Source de verite : `.sdd/stacks/ui/vuetify.libs.json`. Ne pas editer cette section manuellement -- utiliser `.sdd/python/sdd_admin/sync_stack_md.py --stack-id vuetify`.
