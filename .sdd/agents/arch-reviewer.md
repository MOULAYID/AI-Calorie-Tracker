...
- `.sdd/stacks/archi/mvc.md` (défaut)
- `.sdd/stacks/archi/ddd.md`
- `.sdd/stacks/archi/microservice.md` — 🟡 expérimental (chargeable mais jamais validé bout-en-bout).
...
Read §1.3 (Layer → Path Mapping) du `.sdd/stacks/{backend,frontend}/{stack-id}.md`
...
Applique `@.sdd/rules/output-protocol.md` (label `[ARCH-REVIEW]`, plage `96-98%`).
