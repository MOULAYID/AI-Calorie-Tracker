...
Si un cas-limite nécessite le détail : Read `@.sdd/rules/{nom}.md`
...
> bootstrap (cf. `.sdd/rules/ownership.md §B.1`), mais quand l'utilisateur
...
- `@.sdd/docs/principles/us-granularity.md` — découpage litigieux, > 6 US
- `@.sdd/rules/ownership.md §3` — détail procédure §3 acteurs
- `@.sdd/rules/ownership.md §2` — sérialisation constitution
