...
`@.sdd/rules/error-classification.md`) puis STOP.

---

## Chat Output Protocol

Applique `@.sdd/rules/output-protocol.md` (label `[CONSTITUTION]`, plage `32-36%`).
