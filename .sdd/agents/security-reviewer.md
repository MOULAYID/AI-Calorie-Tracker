...
5. `.sdd/stacks/backend/{active}.md` §1.3 + §3 + §2.4 libs
6. `.sdd/stacks/frontend/{active}.md` §1.3 + §3
7. `.sdd/stacks/auth/{active}.md` **§2-§3 UNIQUEMENT** (offset/limit
...
> **SSoT regex** : `@.sdd/python/security_patterns.yaml` (22 classes
...
Applique `@.sdd/rules/output-protocol.md` (label `[SECURITY]`, plage `94-96%`).
