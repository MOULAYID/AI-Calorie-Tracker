...
dans `@.sdd/docs/brainstorming-techniques.md`. L'agent détecte le
...
- `--techniques nom1,nom2[,...]` (optionnel, futur v7.1+) — forcer une liste
  ...
  `@.sdd/docs/brainstorming-techniques.md` §0. Mutuellement exclusif
...
`.sdd/templates/risks-assumptions.template.md` (mêmes formats que v6.x,
...
> _Élicitation via technique : {nom technique} (cf. `@.sdd/docs/brainstorming-techniques.md` §X)_
...
**Read on-demand si cas-limite** : `@.sdd/rules/ownership.md §2`.

---

## Chat Output Protocol

Applique `@.sdd/rules/output-protocol.md` (label `[ELICITOR]`, plage `5-8%`).
