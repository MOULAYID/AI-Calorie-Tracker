...
| Script | [`.sdd/python/sdd_hooks/protect_framework.py`](.sdd/python/sdd_hooks/protect_framework.py) |
| LOC | ~50 |
...
| Script | [`.sdd/python/sdd_hooks/preflight_agent_budget.py`](.sdd/python/sdd_hooks/preflight_agent_budget.py) |
| LOC | ~110 |
...
| Script | [`.sdd/python/sdd_hooks/validate_augment_contract.py`](.sdd/python/sdd_hooks/validate_augment_contract.py) |
| LOC | ~140 |
...
| Script | [`.sdd/python/sdd_hooks/audit_file_ownership.py`](.sdd/python/sdd_hooks/audit_file_ownership.py) |
| LOC | ~150 |
...
| Script | [`.sdd/python/sdd_hooks/record_token_usage.py`](.sdd/python/sdd_hooks/record_token_usage.py) |
| LOC | ~210 |
...
| Script | [`.sdd/python/sdd_hooks/block_env_bypass.py`](.sdd/python/sdd_hooks/block_env_bypass.py) |
| LOC | ~130 |
...
| Script | [`.sdd/python/sdd_hooks/preflight_cost_cap.py`](.sdd/python/sdd_hooks/preflight_cost_cap.py) |
| LOC | ~80 |
...
| Script | [`.sdd/python/sdd_hooks/preflight_stack_combo.py`](.sdd/python/sdd_hooks/preflight_stack_combo.py) |
| LOC | ~150 |
...
| Script | [`.sdd/python/sdd_hooks/validate_stack_consistency.py`](.sdd/python/sdd_hooks/validate_stack_consistency.py) |
| LOC | ~170 |
...
| Script | [`.sdd/python/sdd_hooks/resolve_po_hash_sentinel.py`](.sdd/python/sdd_hooks/resolve_po_hash_sentinel.py) |
| LOC | ~90 |
...
| Script | [`.sdd/python/sdd_hooks/validate_acceptance_gate.py`](.sdd/python/sdd_hooks/validate_acceptance_gate.py) |
| LOC | ~250 |
...
| Script | [`.sdd/python/sdd_hooks/pre_write_lint.py`](.sdd/python/sdd_hooks/pre_write_lint.py) |
| LOC | ~200 |
...
| Script | [`.sdd/python/sdd_hooks/preflight_glob_scope.py`](.sdd/python/sdd_hooks/preflight_glob_scope.py) |
| LOC | ~120 |
...
| Script | [`.sdd/python/sdd_hooks/session_start.py`](.sdd/python/sdd_hooks/session_start.py) |
| LOC | ~120 |
...
|---|---|
| Trigger Claude Code | `PreToolUse` matcher `Agent` |
| Script | [`.sdd/python/sdd_hooks/enforce_two_stage_auditor.py`](.sdd/python/sdd_hooks/enforce_two_stage_auditor.py) |
| LOC | ~180 |
...
| Script | [`.sdd/python/sdd_hooks/auto_invoke_complexity_router.py`](.sdd/python/sdd_hooks/auto_invoke_complexity_router.py) |
| LOC | ~180 |
...
| Script | [`.sdd/python/sdd_admin/framework_smoke.py`](.sdd/python/sdd_admin/framework_smoke.py) |
| LOC | ~400 |
...
|---|---|---|
| `.claude/hooks/preflight-agent-budget.ps1` | [`sdd_hooks/preflight_agent_budget.py`](.sdd/python/sdd_hooks/preflight_agent_budget.py) | dossier renommé `hooks` → `sdd_hooks` |
| `.claude/hooks/protect-framework.ps1` | [`sdd_hooks/protect_framework.py`](.sdd/python/sdd_hooks/protect_framework.py) | idem |
...
|---|---|
| `acquire-libname-lock.ps1` | [`sdd_scripts/acquire_libname_lock.py`](.sdd/python/sdd_scripts/acquire_libname_lock.py) |
...
| `context-budget.ps1` | [`sdd_scripts/context_budget.py`](.sdd/python/sdd_scripts/context_budget.py) |
| `detect-capabilities.ps1` | [`sdd_scripts/detect_capabilities.py`](.sdd/python/sdd_scripts/detect_capabilities.py) |
| `gate-decide.ps1` | [`sdd_scripts/gate_decide.py`](.sdd/python/sdd_scripts/gate_decide.py) |
| `mark-breaking-resolved.ps1` | [`sdd_scripts/mark_breaking_resolved.py`](.sdd/python/sdd_scripts/mark_breaking_resolved.py) |
| `parse-coverage.ps1` | [`sdd_scripts/parse_coverage.py`](.sdd/python/sdd_scripts/parse_coverage.py) |
| `preflight.ps1` | [`sdd_scripts/preflight.py`](.sdd/python/sdd_scripts/preflight.py) |
| `quality-scan.ps1` | [`sdd_scripts/quality_scan.py`](.sdd/python/sdd_scripts/quality_scan.py) |
| `sdd-state.ps1` | [`sdd_scripts/sdd_state.py`](.sdd/python/sdd_scripts/sdd_state.py) |
| `validate-fidelity.ps1` | [`sdd_scripts/validate_fidelity.py`](.sdd/python/sdd_scripts/validate_fidelity.py) |
| `validate-inline-rules.ps1` | [`sdd_scripts/validate_inline_rules.py`](.sdd/python/sdd_scripts/validate_inline_rules.py) |
| `validate-readiness.ps1` | [`sdd_scripts/validate_readiness.py`](.sdd/python/sdd_scripts/validate_readiness.py) |
| `validate-semantic.ps1` | [`sdd_scripts/validate_semantic.py`](.sdd/python/sdd_scripts/validate_semantic.py) |

### 3.4 Scripts → sdd_admin/ (outils dev humains, 5 migrés)

| PowerShell (supprimé) | Python (actif) |
|---|---|
| `framework-smoke.ps1` | [`sdd_admin/framework_smoke.py`](.sdd/python/sdd_admin/framework_smoke.py) |
| `init-status-json.ps1` | [`sdd_admin/init_status_json.py`](.sdd/python/sdd_admin/init_status_json.py) |
| `measure-batch.ps1` | [`sdd_admin/measure_batch.py`](.sdd/python/sdd_admin/measure_batch.py) |
| `sync-stack-md.ps1` | [`sdd_admin/sync_stack_md.py`](.sdd/python/sdd_admin/sync_stack_md.py) |
| `validate-libs-catalog.ps1` | [`sdd_admin/validate_libs_catalog.py`](.sdd/python/sdd_admin/validate_libs_catalog.py) |
...
> sur `main`. Le fichier `.sdd/docs/hooks-and-protections.md` (présent
...
- `.sdd/python/sdd_hooks/*.py` (présence du module)
- `.sdd/docs/hooks-and-protections.md` (présente section §1)
...
- [`.sdd/python/sdd_hooks/`](.sdd/python/sdd_hooks/) — 17 hooks Python
- [`.sdd/python/sdd_admin/framework_smoke.py`](.sdd/python/sdd_admin/framework_smoke.py) — smoke check Stop hook
- [`.sdd/python/_hook.py`](.sdd/python/_hook.py) — wrapper d'invocation
- [`.sdd/docs/MIGRATION.md`](./MIGRATION.md) — guide migration entre versions majeures
- [`.sdd/docs/VERSIONING.md`](./VERSIONING.md) — politique SemVer + freeze
