...
Disponible : `.sdd/python/sdd_scripts/bench_run.py` qui orchestre :
...
- `@.sdd/docs/glossary.md §10` — verdict / severity canoniques
- `@.sdd/python/sdd_scripts/report_token_usage.py` — agrégation tokens existante
- `@.sdd/python/sdd_scripts/parse_coverage.py` — agrégation coverage
- `@.sdd/python/sdd_scripts/query_console_db.py` — read queries SQL
- `@.sdd/docs/CHANGELOG.md` lignes 489, 530, 600, 850 — promesses ROI non mesurées historiquement
