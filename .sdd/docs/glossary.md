...
|---|---|---|
| **backend** | `.sdd/stacks/backend/*.md` | 4 🟢 |
| **frontend** | `.sdd/stacks/frontend/*.md` | 4 🟢 |
| **ui** | `.sdd/stacks/ui/*.md` | 3 🟢 |
| **fullstack** | `.sdd/stacks/fullstack/*.md` | 6 🟡 |
| **mobiles** | `.sdd/stacks/mobiles/*.md` | 2 🟡 |
| **qa** | `.sdd/stacks/qa/*.md` | 7 🟢 |
| **auth** | `.sdd/stacks/auth/*.md` | 2 🟢 |
| **archi** | `.sdd/stacks/archi/*.md` | 1 🟢 + 2 🟡 |
...
| `ArchitecturePattern: X` keyvalue | bullet `- .sdd/stacks/archi/x.md` | config-ssot |
...
- `@.sdd/docs/architecture.md` — vision agents/stacks
- `@.sdd/docs/workflow.md` — détail phases
- `@.sdd/docs/conventions.md` — anti-derive, idempotence, parallélisme
- `@.sdd/docs/CHANGELOG.md` — notes par version (consolidé 2026-06-06)
- `@.sdd/rules/` — 11 règles opérationnelles
- `@.sdd/docs/VERSIONING.md` — politique SemVer + freeze
