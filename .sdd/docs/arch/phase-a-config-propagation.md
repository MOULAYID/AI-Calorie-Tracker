...
> pour alléger le prompt root de l'agent. Référencé via `Read @.sdd/docs/arch/phase-a-config-propagation.md`.
...
backend, en accord avec `.sdd/rules/library-and-stack.md` (allowlist explicite, jamais
de wildcard).
