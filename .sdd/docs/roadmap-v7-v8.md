...
> conservée en LTS pour projets legacy. Cf. `@.sdd/docs/VERSIONING.md`
...
~80 invocations `Read .sdd/stacks/.../X.md` dans `.claude/agents/`,
...
| Stubs backward-compat | 0 (tous supprimés) | grep `Read @.sdd/rules/X.md` legacy = 0 |
