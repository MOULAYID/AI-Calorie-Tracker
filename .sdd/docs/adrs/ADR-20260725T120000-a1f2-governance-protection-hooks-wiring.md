...
existent bien sous `.sdd/python/sdd_hooks/`, mais aucun n'était appelé par le
...
- Inventaire hooks : `.sdd/docs/hooks-and-protections.md` (§1, §2, §4)
- Registre gates : `.sdd/docs/gates-map.md §4`
- Wrapper d'invocation : `.sdd/python/_hook.py`
- Test anti-rot : `.sdd/python/tests/test_gates_map.py`
