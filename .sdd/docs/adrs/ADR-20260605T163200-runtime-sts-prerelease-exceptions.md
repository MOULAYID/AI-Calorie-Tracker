...
- `.sdd/stacks/fullstack/next.libs.json` → `versions.next-auth = "5.0.0-beta.25"`
- `.sdd/stacks/fullstack/nuxt.libs.json` → `versions.nuxt-ui = "3.0.0-alpha.10"`
- `.sdd/stacks/mobiles/maui.libs.json` → `versions.livecharts-maui = "2.0.0-rc4.1"`
