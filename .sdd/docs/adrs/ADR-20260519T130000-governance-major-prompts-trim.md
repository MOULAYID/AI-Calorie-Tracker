...
- `@.sdd/docs/*.md` — long-form architecture/workflow/conventions
- `@.sdd/rules/*.md` — operational rules loaded by agents on demand
...
- Editorial discipline: any new content goes to `@.sdd/docs/` or
  `@.sdd/rules/` first, then a 1-line summary in CLAUDE.md.
