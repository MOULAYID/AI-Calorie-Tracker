...
- Rule : `.sdd/rules/library-and-stack.md §0 (Runtime LTS)` + §7 (Pièges runtime documentés)
- Script : `.sdd/python/sdd_scripts/validate_stack_combo.py` (déterministe, désormais câblé hook PreToolUse — cf. C5)
