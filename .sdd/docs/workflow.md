...
> Document chargé **à la demande** (`Read @.sdd/docs/workflow.md`).
...
│  cf. .sdd/rules/build-and-loop.md                             │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
...
- **Workflow gated back→API gate→front** (depuis 2026-05-07) : la
  ...
  `.sdd/rules/build-and-loop.md`. Anciens default `GatedWorkflow:
...
- **Slim CLAUDE.md** : entry point réduit (~150 lignes) ; le détail
  ...
  `.sdd/docs/{architecture,workflow,conventions}.md` chargés à la
  demande.
