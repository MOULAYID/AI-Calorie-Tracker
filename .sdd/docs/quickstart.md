...
>
> Document chargé **à la demande** (`Read @.sdd/docs/quickstart.md`).
...
Ligne chemin `.sdd/stacks/auth/azure-ad.md` + clés :
...
shadcn/vuetify/radzen (cf. `.sdd/rules/quality.md` Partie B §B.2, ex-ui-tokens.md).
...
- Working Agreement : `@.sdd/docs/WORKING-AGREEMENT.md`
- Conventions strictes : `@.sdd/docs/conventions.md`
- Architecture détaillée : `@.sdd/docs/architecture.md`
