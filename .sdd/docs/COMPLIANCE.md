...
- `@.sdd/docs/KNOWN-LIMITATIONS.md` — limites connues
- `@.sdd/rules/library-and-stack.md` — gestion libs + LTS + CVE
- `@.sdd/rules/error-classification.md §1.11` — classes `[SEC_*]` OWASP
