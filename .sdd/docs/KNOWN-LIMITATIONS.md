...
- `@.sdd/docs/COMPLIANCE.md` — sécurité / RGPD / audit trail
- `@.sdd/docs/SLA.md` — engagement support
- `@.sdd/docs/validated-combos.md §6` — risques par combo
- `@.sdd/rules/library-and-stack.md §B.7` — pièges runtime documentés
- `@.sdd/docs/roadmap-v7-v8.md` — items planifiés
