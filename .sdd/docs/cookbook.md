...
> Pour la doctrine complète : `@.sdd/docs/architecture.md`.
...
Toute classe : `@.sdd/rules/error-classification.md`.
...
| Besoin | Lire |
|---|---|
| Comprendre l'architecture | `@.sdd/docs/architecture.md` |
| Workflow détaillé | `@.sdd/docs/workflow.md` |
| Choisir un combo | `@.sdd/docs/validated-combos.md` |
| Ajouter une lib | `@.sdd/rules/library-and-stack.md` Partie A |
