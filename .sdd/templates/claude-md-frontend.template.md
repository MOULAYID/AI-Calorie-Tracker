...
active-stacks:
  - .sdd/stacks/frontend/{frontend-stack-id}.md
  - .sdd/stacks/ui/{ui-stack-id}.md
  - .sdd/stacks/auth/{auth-stack-id}.md     # si auth actif
---
...
- Mapping composants: voir `.sdd/stacks/ui/{id}.md §2`
...
- Source de vérité : `.sdd/stacks/frontend/{id}.md` + `.sdd/stacks/ui/{id}.md` (à relire si CLAUDE.md ne suffit pas).
