...
active-stacks:
  - .sdd/stacks/backend/{backend-stack-id}.md
...
- Source de vérité : `.sdd/stacks/backend/{id}.md` + `.sdd/stacks/auth/{id}.md` (à relire si CLAUDE.md ne suffit pas pour une décision précise).
