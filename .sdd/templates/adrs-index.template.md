...
> Source de vérité : Glob `workspace/.sys/.context/adrs/ADR-*.md`.
...
- `.sdd/rules/ownership.md` Partie B — règles de création/écriture (ex-constitution.md)
- `.sdd/rules/ownership.md §3` (Partie B) — numérotation atomique anti-race (ex-file-ownership.md §3)
- `workspace/.sys/.context/constitution.md` §6 — index dans la constitution (rebuild par `arch`)
